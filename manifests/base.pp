...
class cegeka_apache::base {
  ...
  case $facts['os']['release']['major'] {
    ...
    '7': {
      $real_apache_modules = ['alias', 'auth_basic', 'authn_file', 'authz_core', 'authz_groupfile', 'authz_host', 'authz_user', 'autoindex', 'dir', 'env', 'mime', 'negotiation', 'rewrite', 'setenvif', 'status', 'mpm_prefork', 'unixd', 'access_compat', 'socache_shmcb', 'systemd']
    }
  }
